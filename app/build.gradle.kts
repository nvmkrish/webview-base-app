...
android {
    ...
    defaultConfig {
        ...
        // 🔴 THIS IS REQUIRED
        buildConfigField("String", "WEB_URL", "\"https://www.urbanmonkey.com/\"")
        buildConfigField("String", "SPLASH_COLOR", "\"#ffffff\"")
        buildConfigField("String", "SPLASH_LOGO_URL", "\"\"")
        buildConfigField("String", "SPLASH_TEXT", "\"Urban Monkey\"")
        ...
        buildConfigField("String", "NAV_ITEMS_JSON", "\"[{\\\"label\\\":\\\"Home\\\",\\\"path\\\":\\\"https://www.urbanmonkey.com/\\\"},{\\\"label\\\":\\\"Collection\\\",\\\"path\\\":\\\"https://www.urbanmonkey.com/collections/all\\\"},{\\\"label\\\":\\\"About Us\\\",\\\"path\\\":\\\"https://www.urbanmonkey.com/pages/about-us\\\"}]\"")
        buildConfigField("String", "APP_ID", "\"urbanmonkey\"")
        buildConfigField("String", "BACKEND_URL", "\"https://jacquie-unevocable-adaline.ngrok-free.dev\"")
        buildConfigField("String", "APP_NAME", "\"Urban Monkey\"")
