...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "NAV_ITEMS_JSON", "\"[{\"label\":\"Home\",\"path\":\"https://claude.ai/\"},{\"label\":\"Chats\",\"path\":\"https://claude.ai/recents\"},{\"label\":\"Account\",\"path\":\"https://claude.ai/settings/general\"}]\"")
